                        ...
                        <table class="mb-3 datatable" id="offreDatatable">
                            ...
                            @for ($i = 0; $i < $num; $i++)
                                <tr class="card p-2 w-100 mt-2 mb-0">
                                    ...
                                    <td class="py-0 my-0    ">
                                        <div class="filter">
                                            <a class="icon text-danger fw-bold" href="#"
                                        ...
                                        <div class="py-0 my-0 list-notify row align-items-center justify-content-center">
                                            <div class="card-title fw-bold py-0 my-1">
                                                ...
                                                <span class="badge bg-warning text-light rounded-pill" style="font-size: 12px;">11/12/2024</span> - 
                                                <span class="badge bg-info text-light rounded-pill" style="font-size: 12px;">Nouveau</span>
                                            </div>
                                            <div class="card-body py-0 mb-1">
                                                Votre candidature pour le poste <strong>Développeur Web</strong> est
