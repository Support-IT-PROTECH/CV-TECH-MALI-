...
@section('content')
    <!--
                                                                      ...
                                                                      ```
                                                                    -->
    <form enctype="multipart/form-data" method="POST" action="{{ route('travail.store') }}">
        @csrf
        <div class="space-y-12">
            <div class="border-b border-gray-900/10 pb-12">
                <h2 class="text-base/7 font-semibold text-gray-900">Ajouter une nouvelle offre</h2>
                <p class="mt-1 text-sm/6 text-gray-600">This information will be displayed publicly so be careful what you
                    share.</p>

                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    <div class="sm:col-span-4">
                        <label for="company" class="block text-sm/6 font-medium text-gray-900">Nom de l'entreprise</label>
                        <div class="mt-2">
                            <div
                                ...
                                <input type="text" name="company" id="company" autocomplete="company"
                                    ...
                                    placeholder="Africa Agency Mining">
                            </div>
                        </div>
                    </div>
                    <div class="sm:col-span-4">
                        <label for="logo" class="block text-sm/6 font-medium text-gray-900">Logo de l'entreprise</label>
                        <div class="mt-2">
                            <div
                                class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                    ...
                    <div class="sm:col-span-4">
                        <label for="offre" class="block text-sm/6 font-medium text-gray-900">Nom de l'offre</label>
                        <div class="mt-2">
                            <div
                                class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">

                                <input type="text" name="offre" id="offre" autocomplete="offre"
                                    class="block flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm/6"
                                    placeholder="1 Spécialiste en Marketing Digital ">
                            </div>
                        </div>
                    </div>
        ...
        <div class="mt-6 flex items-center justify-end gap-x-6">
            <a href="{{ route('travail.index') }}" type="button" class="text-sm/6 font-semibold text-gray-900">Cancel</a>
            <button type="submit"
